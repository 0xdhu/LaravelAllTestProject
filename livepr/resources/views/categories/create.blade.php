			...
			<div class="card card-primary">
				...
				<div class="card-body">
					...
					<form method="POST" action="/categories" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="hlsUrlPhoneAUTO" class="col-md-4 col-form-label text-md-right" style="display: none;">HlsUrlPhoneAUTO</label>

                            <div class="col-md-6">
                                <input id="hlsUrlPhoneAUTO" type="hidden" class="form-control" name="hlsUrlPhoneAUTO" value="random">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="hlsUrlPhoneAUTO" class="col-md-4 col-form-label text-md-right">Channel Folder</label>

                            <div class="col-md-6">
                                <select class="form-control" name="channelfolder">
                                    <option>Select Channel</option>
                                    @forelse($directories as $directory)
                                    <option>{{$directory}}</option>
                                    @empty
                                    <option>Channel Doesn't Exist</option>
                                    @endforelse
                                </select>
                                @if (session('status'))
                                ...
                                @endif
                                <!-- <input id="channelfolder" type="text"  value="/upload/" required placeholder="Write folder path ex: /upload/Bear/"> -->
                            </div>
                        </div>
                        <!-- <div class="form-group row">
